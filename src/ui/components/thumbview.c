...
/** 载入缩略图 */
static void ThumbLoader_Start( ThumbView view, LCUI_Widget target )
{
	size_t len;
	DB_Dir dir;
	ThumbViewItem item;
	...
	item->loader = loader;
	_DEBUG_MSG( "loader: %p, target: %p, target state: %d\n",
