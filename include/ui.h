...
#define ID_TXT_CURRENT_DETECTOR_MODEL	"txt-current-detector-model"
...
#define ID_VIEW_DETECTOR_SETTING	"view-detector-settings"
...
#define ID_DROPDOWN_DETECTOR_MODELS	"dropdown-detector-models"
