/* ***************************************************************************
* scrollload.h -- scroll loading, used to allow widget to automatically load 
...
/* ****************************************************************************
* scrollload.h -- 滚动加载，用于让部件能在滚动到可见区域时自动加载数据.
*
...
#ifndef __SCROLLLOAD_H__
#define __SCROLLLOAD_H__
