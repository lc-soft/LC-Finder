/* ***************************************************************************
 * LCUIRenderer.cpp -- UWP display support for LCUI
 *
...
/* ****************************************************************************
 * LCUIRenderer.cpp -- LCUi 的 UWP 版图形输出支持
 *
...
LCUIRenderer::LCUIRenderer( const std::shared_ptr<DX::DeviceResources>& deviceResources ) :
...
void LCUIRenderer::CreateDeviceDependentResources()
{

}

void LCUIRenderer::CreateWindowSizeDependentResources()
{
...
void LCUIRenderer::ReleaseDeviceDependentResources()
{
...
LCUI_DisplayDriver LCUI_CreateUWPDisplay( void )
{
	...
	strcpy( driver->name, "Universal Windows" );
